        ...
        <li key={item?.id} className="group relative transition-all">
          ...
          {item.subNav && (
            <div
              ...
              rounded-xl bg-zinc-50 border border-black/30
              ...
              before:bg-zinc-50 before:rotate-45 before:border-l before:border-t
                ...
                <div key={nav.id} className="group/subnav relative">
                  <Link
                    ...
                    className={`group/navlink relative flex w-full items-center justify-between
                      ...
                      hover:bg-color1 hover:text-white rounded-lg mx-1 
                      ${
                        activeItem ===
                        (FormatHref(nav.href)
                          .split("/")
                  ...
                  {nav.subNav && (
                    <div
                      ...
                      w-auto rounded-xl bg-zinc-50 border border-black/30
                      py-2 shadow-[0_16px_40px_rgba(0,0,0,0.4)]
                        ...
                        >
                          ...
                          {subNav.subNavv && subNav.subNavv.length > 0 && (
                            <div
                              ...
                              w-auto rounded-xl bg-[#2B3944] border border-black/30
                              py-2 shadow-[0_16px_40px_rgba(0,0,0,0.4)]
