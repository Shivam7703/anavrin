...
export default function VisaSlider() {
  ...
  return (
    <section className="ser-bg  relative overflow-hidden py-14 px-4 md:px-12 lg:px-20">

      {/* Floating plane decoration */}
      <Image
        src={footerImage}
        alt="immigration"
        className="z-0 absolute -bottom-2 right-[3%]  object-contain w-max sm:h-56 h-28  pointer-events-none"
      />
       <Image
        src={para}
        alt="immigration"
        className="z-0 absolute top-[7%] left-[1%] object-contain w-max sm:h-28 h-14  pointer-events-none animate-y"
      />
          ...
          {data?.cards.map((card: any) => (
            <SwiperSlide key={card.id} className="group !h-auto pb-2">
              ...
              <div className="flex flex-col relative  overflow-hidden
                transition-shadow duration-400 h-full">
                ...
                {/* ── CONTENT ── */}
                <div className="w-[92%] mx-auto sticky z-10 -mt-20 md:-mt-28">
{/* Red icon badge — bottom-left of image */}
                  ...
                  <div className="px-6 pt-5 pb-6 space-y-4 text-center bg-white">
                  {/* Title */}
